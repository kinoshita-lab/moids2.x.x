...
{
    0, 0, 0, 0, 30, // ぴー　random, 1/3, 2/3, 4/5, 100% 本当は1分

    5, 5, 10, 20,    // 全部がしょわしょわ125に変わる　本当は20秒ずつ？

    2, 2, 2, 2, 2, // しょわしょわのディレイが増える 250, 375, 500, 625, 750,
    2, 2, 2, 2, 2, // しょわしょわのディレイが増える 875, 100, 1125, 1250, 2500,
    2, 2, 2, 2,    // しょわしょわのディレイが増える 5000, 10000, 15000, 25000,
    1, 1, 1, 1, 1, // しょわしょわの数が減っていく 93, 86, 79, 72, 65, 
    0, 1, 0, 1, 0, // しょわしょわの数が減っていく 58, 510, 44, 37, 30,
    1, 0, 1,       // しょわしょわの数が減っていく 23, 16, 9
    3, 3,3 , 60*14,    // Moidsの感度が上がっていく 7, 6, 5, 4, で14分
    5, 4, 3, 2, 1, 1, // 感度が下がっていく
    600, //死
};
...
volatile int sequence_length_table[] =
{
    0,  0,  0,  0, 0, // ぴー　random, 1/3, 2/3, 4/5, 100% 本当は1分

    0, 0, 0, 0,    // 全部がしょわしょわ125に変わる　本当は20秒ずつ？

    0, 0, 0, 0, 0, // しょわしょわのディレイが増える 250, 375, 500, 625, 750,
    0, 0, 0, 0, 0, // しょわしょわのディレイが増える 875, 1000, 1125, 1250, 2500,
    0, 0, 0, 0,    // しょわしょわのディレイが増える 5000, 10000, 15000, 25000,

    0, 0, 0, 0, 0, // しょわしょわの数が減っていく 93, 86, 79, 72, 65, 
    0, 0, 0, 0, 0, // しょわしょわの数が減っていく 58, 510, 44, 37, 30,
    0, 0, 0,       // しょわしょわの数が減っていく 23, 16, 9
    0, 0, 0, 9000,    // Moidsの感度が上がっていく 7, 6, 5, 4, で10分
    0, 0, 0, 0, 0, 0, // 感度が下がっていく
    600, //死
...
enum SequenceName
{
    ...
    //interactive Mode 7, 6, 5, 4を5秒ずつ 1on/offは25msec
    moids7,
    moids6,
    moids5,
    moids4,
